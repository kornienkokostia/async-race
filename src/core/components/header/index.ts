...
export default class Header extends Component {
  ...
  createNavButtons() {
    ...
    const garageBtnImg = this.elFactory('img', {
      class: 'header-btn-img',
      src: './assets/images/icons/garage-btn.svg',
      alt: 'header-btn-img',
    });
    garageBtnImg.ondragstart = () => false;
    const garageBtnSpan = this.elFactory('span', {});
    garageBtnSpan.textContent = 'Garage';
    const garageBtn = this.elFactory(
      'button',
      { class: 'header-btn header-btn-garage btn' },
      garageBtnImg,
      garageBtnSpan,
    );
    ...
    const winnersBtnImg = this.elFactory('img', {
      class: 'header-btn-img',
      src: './assets/images/icons/winners-btn.svg',
      alt: 'header-btn-img',
    });
    const winnersBtnSpan = this.elFactory('span', {});
    winnersBtnSpan.textContent = 'Winners';
    const winnersBtn = this.elFactory(
      'button',
      { class: 'header-btn header-btn-winners btn' },
      winnersBtnImg,
      winnersBtnSpan,
    );
